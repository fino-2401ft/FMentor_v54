// src/views/EditLessonScreen.tsx
...
import { useEditLessonViewModel } from "../viewmodels/EditLessonViewModel";
import { useRoute, useNavigation, RouteProp } from "@react-navigation/native";
import { RootStackParamList } from "../navigation/AppNavigator";
import Header from "../components/Header";

type EditLessonRouteProp = RouteProp<RootStackParamList, "EditLesson">;
...
const EditLessonScreen = () => {
    ...
    const {
        ...
        handleUploadVideo,
        handleUpdateLesson,
    } = useEditLessonViewModel(lessonId, courseId);
